...
def train(cfg: DictConfig) -> None:
    ...
    torch.save(model.state_dict(), os.path.join(SCRIPT_DIR, "trained_model.pth"))
    ...
    artifact.add_file(os.path.join(SCRIPT_DIR, "trained_model.pth"))
    ...
    axs[1].legend()
    plt.savefig(os.path.join(SCRIPT_DIR,"training_statistics.png"))
    # save plot to wandb
    wandb.log({"training_statistics": wandb.Image(os.path.join(SCRIPT_DIR,"training_statistics.png"))})
